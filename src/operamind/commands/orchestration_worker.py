"""Long-running Capability worker for agent-neutral OrchestrationTask execution."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Claim and execute Capability-matched OrchestrationTask records"
    )
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        with psycopg.connect(database_url, autocommit=True) as connection:
            ...
            repository = OrchestrationTaskRepository(connection, scheduling_policy)
