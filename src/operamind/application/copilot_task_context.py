"""Build the bounded internal execution context for one unified Copilot Change Task."""
...
class CopilotTaskContextRequest:
    project_id: str
    ...
    def __post_init__(self) -> None:
        if any(
            ...
            raise ValueError("Copilot Change Task context fields must not be blank")


class CopilotTaskContextService:
    ...
    def get(self, request: CopilotTaskContextRequest) -> dict[str, object]:
